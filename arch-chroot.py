...
def update_config(filename, target_line, new_value=None, remove_comment=False):
    updated_lines = []
    found_target = False
        ...
        for line in lines:
            if line.strip() == target_line:
                ...
                if new_value is not None:
                    line = line.replace('false', new_value)
...
def arch_system():
    ...
    update_config(filename, target_lines, remove_comment=True)
...
def grub():
    ...
    update_config(filename, target_line, new_value=new_value, remove_comment=True)
